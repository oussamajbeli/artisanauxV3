...
<body>
    ...
    <div class="wrapper ">
        ...
        -->
          <div class="logo">
             <p class="simple-text logo-normal"> Artisanaux</p>
        </div>
              ...
              <div class="collapse navbar-collapse justify-content-end">
                ...
                <ul class="navbar-nav">
                  <li class="nav-item dropdown">
                    <a class="nav-link" href="{{url('notification')}}" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                      <i class="material-icons">notifications</i>
                      <p style="text-decoration:hidden">{{
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink">
                      ...
                      <a class="dropdown-item" href="">{{$notification->msg}}</a>
                    @endforeach
                    </div>
                  </li>
                  <li class="nav-item dropdown">
                    <a class="nav-link" href="javascript:;" id="navbarDropdownProfile" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                      <i class="material-icons">{{session()->get('user')->name}}</i>
                      <p class="d-lg-none d-md-block">
                        Account
                      </p>
                    </a>
          ...
          <footer class="footer">
            <div class="container-fluid">
              ...
              <div class="copyright float-right">
                ...
                <a href="{{url('/')}}" target="_blank">Artisanaux nabeul</a> 
              </div>
            </div>
          </footer>
        </div>
